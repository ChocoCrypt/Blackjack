"""
Performing Open AI training to reinforcement learning.
...
class Agent_BlackJack:
    ...
    blackjack game by the implementation of Q learning.
    """

    def __init__(self, delta, gamma, epsilon):
        """Initialze data for getting Q Matrix."""
    ...
    def play(self):
        ...
        while(not done):
            ...
            new_q_value = (1-self.LEARNING_RATE) * ant + \
